...
<body>
                            ...
                            <div class="collapsible-body">
                                <ul>   
                                    <li><a href="indent-form.php">Product Indent Form</a>
                                     ...
                                     <li class="active"><a href="preindent-form.php">Pre-Fab Indent Form</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                <ol class="breadcrumbs">
                  ...
                  <li class="active">Pre-Fabricated Indent Form Details</li>
                </ol>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                  <div class="col s12 m12 l6">
                        <div class="card-panel">
                          <div class="row">
                                <form class="formValidate" id="formValidate" method="post" action="preindent-form.php">
                                  <div class="row">
                                        <div class="col s12">
                                            <label for="crole">Pre-Fabricated *</label>

                                              <?php 
                                              include("database/db_conection.php");

                                              $result=mysqli_query($dbcon,"select Id,Name from pre_fabricated_entity");
                                               $option='';
                                               while($row = mysqli_fetch_array($result)){
                                                  $option.='<option value ="'.$row['Name'].'">'.$row['Name'].'</option>';
                                              }                              
                                                                    ?>
                                                                      <select class="error browser-default" id="plist1" name="plist" data-error=".errorTxt6" onchange1="this.form.submit()">
                                      ...
                                      <div class="input-field">
                                       ...
                                       <!--  <div class="input-field col s12">
                                        ...
                                        <div class="input-field col s12">
                                            <button class="btn waves-effect waves-light right submit" id="actionPreIndent">Submit
 ...
 <!-- START FOOTER -->
  ...
  <script type="text/javascript">
    ...
    $('#actionPreIndent').click(function(e)
    {
       e.preventDefault();
