...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2017 at 09:44 AM
...
(6, NULL, '', 'Approved', 'Store Keeper', 'Fieldtech', 'F-1', NULL, '2017-10-25', '2017-10-25', 11, '', 'kjbkjnkjnkjnkjnkllkm kjkjnkjn'),
(7, NULL, '', 'Approved', 'Store Keeper', 'Fieldtech', 'M-3', NULL, '2017-10-25', '2017-10-25', 13, '', ''),
(8, NULL, '', 'Approved', 'Store Keeper', 'Fieldtech', 'F-2', NULL, '2017-10-26', '2017-10-26', 14, 'aa', '');
...
(5, NULL, '20cm', 'Rejected', 'Store Keeper', 'Fieldtech', 'Colar Soft', '2017-10-25', '2017-10-25', 10, '', ''),
(6, NULL, '', 'Approved', 'Store Keeper', 'Fieldtech', 'Finger Exercise', '2017-10-25', '2017-10-25', 12, '', '');
...
(2, '3', '67,56,78,', 'Approved', 'Admin', 'StoreKeeper', '1,4,8,', '2017-10-25', '2017-10-25', '');
...
(1, 'P.O.P .Bandage 15CM 2.7 Mtrs', 30, 100, NULL, NULL, 'Nos'),
...
(10, 'Velcro2" Smooth Black', 3.5, 20, NULL, NULL, 'Meter'),
(11, 'Velcro2" Ruguf Black', 1.5, 20, NULL, NULL, 'Meter'),
...
(18, 'Nylon tape 2"', 10, 10.76, NULL, NULL, 'Feet'),
...
(24, 'Thread # 30 (Vardan Products) Black', 0, 1, NULL, NULL, 'Meter'),
...
(29, 'Upperlather', 0, 7.5, NULL, NULL, 'Dcm'),
(30, 'Ethaflex 3mm', 0.5, 110, NULL, NULL, 'Sheet'),
(31, 'Cotton Cloth', 1, 183, NULL, NULL, 'Meter'),
(32, 'Velcro2" Smooth White', 0, 20, NULL, NULL, 'Meter'),
(33, 'Ms Flat 3/4" 3mm', 1, 55, NULL, NULL, 'Nos'),
(34, 'Velcro2" Ruguf White', 0, 20, NULL, NULL, 'Meters'),
...
(50, 'Lining Lather', 0, 7.5, NULL, NULL, 'Dcm'),
(51, 'Stepner', 3, 5, NULL, NULL, 'Meters'),
(52, 'Rubber Sole', 0, 50, NULL, NULL, 'Sheet'),
(53, 'Laze', 3, 10, NULL, NULL, 'Pair'),
(54, 'I Let', 60, 1, NULL, NULL, 'Nos'),
(55, 'Bt sole', 0.75, 0.25, NULL, NULL, 'Kgs'),
(56, 'MCR', 0, 300, NULL, NULL, 'Sheet'),
...
(63, 'Plating Charge', 0, 650, NULL, NULL, 'Nos'),
(64, 'Ceat Clamp', 2, 45, NULL, NULL, 'Nos'),
(65, 'Carbet', 0.75, 120, NULL, NULL, 'Kgs'),
(66, 'Gas welding rod', 0, 90, NULL, NULL, 'Kgs'),
(67, 'Spring', 2, 25, NULL, NULL, 'Nos'),
(68, 'Ark welding rod', 0, 10, NULL, NULL, 'Nos'),
(69, 'Coster Wheel 6"', 2, 380, NULL, NULL, 'Nos'),
(70, 'Bold & Nut 12mm', 2, 15, NULL, NULL, 'Dcm'),
(71, 'Bold & Nut 8mm', 2, 3, NULL, NULL, 'ML'),
(72, 'Washer', 8, 2, NULL, NULL, 'Nos'),
(73, 'Bold & Nut 5mm', 6, 0.5, NULL, NULL, 'Meters'),
(74, 'Paint', 1.5, 310, NULL, NULL, 'Liter'),
(75, 'Patti', 0, 90, NULL, NULL, 'Liter'),
(76, 'Wood Primer', 0, 75, NULL, NULL, 'Liter'),
(77, 'Nail', 0, 190, NULL, NULL, 'Kgs'),
(78, 'Wood Beeding', 0, 3, NULL, NULL, 'Feet'),
(79, 'Played 1/2"', 9, 75, NULL, NULL, 'Square Feet'),
(80, 'Rexen', 1.5, 130, NULL, NULL, 'Meters'),
(81, 'Thermafoom', 1.5, 90, NULL, NULL, 'Meters'),
(82, 'Eath Foom 10mm', 0, 900, NULL, NULL, 'Sheet'),
(83, 'Wing Bold', 36, 38, NULL, NULL, 'Dcm'),
(84, 'Bold & Nut 6mm', 0, 3, NULL, NULL, 'ML'),
...
(95, 'Ms Pipe 7/8"18 gauge', 3, 15, NULL, NULL, 'Feet'),
(96, 'Ms Pipe 1"16 gauge', 0, 17, NULL, NULL, 'Feet'),
(97, 'Ms Pipe 3/4 18 gauge', 39, 10, NULL, NULL, 'Feet'),
(98, 'Ms Pipe 1 1/4"16 gauge', 0, 22, NULL, NULL, 'Feet'),
(99, 'Ms Flat1" 6mm & 3/4" 1 1/4"', 12, 25, NULL, NULL, 'Kgs'),
(100, 'Played 3/4"', 0, 109, NULL, NULL, 'Square Feet'),
(101, 'Tinner', 0.75, 90, NULL, NULL, 'Liter'),
(102, 'M S round Rod 12mm', 0.5, 55, NULL, NULL, 'Kgs'),
(103, 'Matal Past', 0.5, 90, NULL, NULL, 'Liter'),
(104, 'Tingles', 5, 380, NULL, NULL, 'Kgs'),
...
--
ALTER TABLE `indent_table`
  MODIFY `Indent_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `raw_indent_table`
  MODIFY `R_Indent_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
