                         ...
                         <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-social-pages"></i> Store Keeper</a>
                            <div class="collapsible-body">
                                <ul>  
                                    ...
                                    <li class="active"><a href="new-pre-fab.php">Pre-Fab Indent Form</a></li>
                                </ul>
                            </div>
                        </li>
            ...
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                <ol class="breadcrumbs">
                  ...
                  <li class="active">Pre-Fabricated Form</li>
                </ol>
              </div>
            </div>
          </div>
                                  ...
                                  <div class="row">                                       
                                          <div class="col s12">
                                            ...
                                            <?php 
                                              ...
                                              $result=mysqli_query($dbcon,"SELECT i.Indent_Id,pt.Patient_Name,i.Name FROM indent_table i, patient_details pt,pre_fabricated_entity p WHERE i.Patient_Id=pt.Patient_Id and i.Name=p.Name and i.User_Type='Field Technician' and i.State='Raised'");
                                               $option='';
                                               while($row = mysqli_fetch_array($result)){
                                                  $option.='<option value ="'.$row['Indent_Id'].'">'.$row['Name'].'</option>';
                                              }                               
                                                                    ?>
...
function fetch_select(val)
{
 ...
 success: function (response) {      
  document.getElementById("ides").innerHTML=response[0]; 
