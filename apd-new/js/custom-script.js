        ...
        function updateLogo(theme) {
            ...
            logoImages.forEach(element => {
                if (element.tagName === 'IMG') {
                    // Update main img src
                    if (theme === 'light') {
                        element.src = 'images/logo-dark.png';
                    } else {
                    ...
                    if (theme === 'light') {
                        element.srcset = 'images/logo-dark.png';
                    } else {
                        element.srcset = 'images/Logo.jpg';
                    }
                }
            });
        }
...
On Tue, Mar 3, 2026 at 10:36 AM ravindra <ravindrag.85@gmail.com> wrote:
Proteogen
